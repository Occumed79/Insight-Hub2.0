...
PR #198 changes AOR to a 3D globe default while retaining a 2D fallback and existing data capabilities. The globe uses the MapTiler renderer directly without an additional binary particle-shell asset, custom shaders, a Three.js renderer, a CSS-generated orb, or a MapTiler halo.
