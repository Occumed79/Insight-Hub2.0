...
function isActivePath(itemHref: string, currentPath: string) {
  ...
  if (itemHref === "/war-costs-intelligence" && ["/war-costs", "/war-costs-tools", "/war-costs-site-evidence"].includes(currentPath)) return true;
  return false;
}
