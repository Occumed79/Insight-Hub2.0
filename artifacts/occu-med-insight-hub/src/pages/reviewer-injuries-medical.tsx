    ...
    <div className="rh-stack">
      ...
      {tab === "injury" ? <>
        ...
        <section className="rh-support-grid">
          ...
          <div className="rh-card is-full is-quiet"><div className="rh-label">Interpretation boundary</div><p className="mt-2">OSHA case-detail percentages describe the distribution of coded cases in the matched imported records, not the probability that a worker will be injured. OSHA ITA reporting does not cover every employer or worker and does not establish fault, negligence, compensability, or causation. O*NET evidence describes job demands and is never presented as an injury rate.</p></div>
        </section>
      </> : <>
