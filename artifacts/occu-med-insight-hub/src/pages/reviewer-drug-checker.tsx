              ...
              <div className="rh-hero-main">
                ...
                <div className="rh-molecule-stage mt-6">
                  ...
                  {moleculeLoading ? (
                    ...
                    <div className="rh-molecule-empty">Search and select a medication. The hero uses the actual PubChem compound structure and renders only the molecular artwork over the aurora stage.</div>
                  )}
                </div>
              </div>
