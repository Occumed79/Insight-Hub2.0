...
export const versarGlobalSolutionsMetrics: Metric[] = [
  ...
  { id: "versar-htrw-revenue-mix", companyId: "versar-global-solutions", label: "Environmental remediation / HTRW mix", value: 45, unit: "percent", category: "financial", trend: 8.2, sourceId: "versar-report-hazwoper" },
  { id: "versar-munitions-revenue-mix", companyId: "versar-global-solutions", label: "Munitions response mix", value: 20, unit: "percent", category: "financial", trend: 9.2, sourceId: "versar-report-uxo-munitions" },
  { id: "versar-construction-management-mix", companyId: "versar-global-solutions", label: "Construction management mix", value: 20, unit: "percent", category: "financial", trend: 7.1, sourceId: "versar-report-cpss" },
  { id: "versar-security-systems-mix", companyId: "versar-global-solutions", label: "Security systems mix", value: 10, unit: "percent", category: "financial", trend: 5.2, sourceId: "versar-report-snapshot" },
  { id: "versar-cyber-mix", companyId: "versar-global-solutions", label: "IT / cyber mix", value: 5, unit: "percent", category: "financial", trend: 3.4, sourceId: "versar-report-snapshot" },
