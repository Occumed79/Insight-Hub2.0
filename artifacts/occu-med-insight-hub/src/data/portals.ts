...
export const portalCards: PortalConfig[] = [
  ...
  { title: "Geographic Data", description: "Map one company’s global footprint, facilities, countries, activity clusters, and regional service opportunities.", href: "/geographic-data", mode: "internal", imageKind: "geo" },
