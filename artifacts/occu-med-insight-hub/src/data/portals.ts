...
export const portalCards: PortalConfig[] = [
  ...
  { title: "Entity Intelligence", description: "Open the configured relationship workspace for entity records, needs, and decision patterns.", href: EXTERNAL_PORTAL_LINKS.entity, mode: "external", imageKind: "entity", envName: "VITE_ENTITY_INTELLIGENCE_URL" },
  { title: "Entity Discovery", description: "Open the configured discovery workspace for employer research and business development targeting.", href: EXTERNAL_PORTAL_LINKS.discovery, mode: "external", imageKind: "discovery", envName: "VITE_ENTITY_DISCOVERY_URL" },
